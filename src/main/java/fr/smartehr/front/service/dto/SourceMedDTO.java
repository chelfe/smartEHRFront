...
/**
 * A DTO for the SourceMed entity.
 */
public class SourceMedDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SourceMedDTO sourceMedDTO = (SourceMedDTO) o;
        if(sourceMedDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), sourceMedDTO.getId());
    }
