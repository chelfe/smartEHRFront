...
import fr.smartehr.front.config.audit.AuditEventConverter;
import fr.smartehr.front.domain.PersistentAuditEvent;
...
import static fr.smartehr.front.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
